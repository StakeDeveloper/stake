...
int nAnonymizeStakeAmount = 1000;
...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\Stake
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\Stake
    // Mac: ~/Library/Application Support/Stake
    // Unix: ~/.Stake
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Stake";
#else
    fs::path pathRet;
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "Stake.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "staked.pid"));
