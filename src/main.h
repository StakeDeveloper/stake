...
static const int64_t STATIC_POS_REWARD = 3.5 * COIN; //Constant reward of 3.5 STAKE per COIN
...
static const int64_t MAX_MONEY = 1000000000 * COIN; // 1M PoW coins
...
inline int64_t GetMNCollateral(int nHeight) { return 77777; }
